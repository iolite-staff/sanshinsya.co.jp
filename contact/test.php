...
<!--	<script src="http://code.jquery.com/jquery-1.12.3.min.js"></script>-->
	<?php
	foreach ($_SESSION['PPOST'] as $key => $value) {
?>
<!--<script>
$(function() {
	$(window).on('load',function(){
    $('[name="<?=$key?>"]').prop('checked', $(this).prop('checked'));
  });
});
</script>-->
<?php
...
<article id="sub_contents_area">
	...
	<section>
		<div>
			<form method="POST" action="./test.php" name="contact_form" id="contact_form" autocomplete="off">
				<div class="form_area">
