			...
			<form method="POST" action="./confirm.php" name="contact_form" id="contact_form" autocomplete="off">
				...
				<div class="privacy_area">
					...
					<div class="scroll_message">
						当社はお客様の個人情報を取得するにあたり、以下のとおりa)～ｇ)の事項を遵守し適正管理に努めます。<br />
						a)　株式会社三進社　個人情報保護管理者　木曽　鉄生<br />
						連絡先　電話：03-5621-3848　FAX:03-5621-3849<br />
						b)　利用目的について。 1. お客様が当社の会員としてサービスを利用する場合。 2. 製品を提供する為の取引遂行にあたり、製品の発送、お問い合わせへの対応、当社からお客様へのお問い合わせ、また、その他取引業務にあ…
					</div>
